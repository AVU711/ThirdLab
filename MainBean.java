...
public class MainBean {
    ...
    public String getDrawingDot(String x, String y, long result){
        return String.format("drawDot(%s, %s, %s)", x, y, result);
    }

    public long isHit(String res){
        if (res.equals("Попадение")){
            return 1;
        }else{
            return 0;
        }
